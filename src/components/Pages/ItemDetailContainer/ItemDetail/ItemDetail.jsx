        ...
        <>
            ...
            <div className='itemDetail'>     
                <div className='itemImage'>
                    <img src={product.image} className='itemImage_img' alt='Imagen del producto'/>
                </div>
                <div className='itemDetails'>
                    ...
                    <div className='itemHelpers'>
                        ...
                        <div className='itemHelper'>
                            ...
                            <p className='itemHelper_p' >Ante cualquier consulta podes contactarnos por whatsapp</p>
                        </div>
                    </div>
                </div>
            </div>
