...
const ContactDetails = () => {
    ...
    if(messageSent===true){
        return (
            <Message h2={'Mensaje enviado'} p={'¡Nos pondremos en contacto a la brevedad!'} />
        )
    }
        ...
        <div className='contactDetails'>
            <div className='contactForm'>
                ...
                <div className='contactDetails_captcha'>
                    <ReCAPTCHA sitekey='6LeIxAcTAAAAAJcZVRqyHh71UMIEGNQ_MXjiZKhI' onChange={onChange} onExpired={onchange} />
                </div>
